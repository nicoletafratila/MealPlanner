...
namespace Identity.Api.Tests.Features.ApplicationUser.Commands.Unlock
{
    ...
    public class UnlockCommandHandlerTests
    {
        ...
        public async Task Handle_UserNotFound_ReturnsFailure()
        {
            ...
            _userManagerMock.Verify(m => m.ResetAccessFailedCountAsync(It.IsAny<Common.Data.Entities.ApplicationUser>()), Times.Never);
        }

        [Test]
        public async Task Handle_Success_ResetsCountAndClearsLockout_AndReturnsSuccess()
        {
            var user = new Common.Data.Entities.ApplicationUser { Id = "user-1", UserName = "alice" };
