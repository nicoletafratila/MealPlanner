...
namespace Identity.Api.Tests.Features.Authentication.Commands.ConfirmEmail
{
    ...
    public class ConfirmEmailCommandHandlerTests
    {
        ...
        {
            var user = new Common.Data.Entities.ApplicationUser { Id = "user-id", UserName = "testuser" };
            ...
            _userManagerMock.Verify(m => m.UpdateAsync(It.IsAny<Common.Data.Entities.ApplicationUser>()), Times.Never);
        }

        [Test]
        public async Task Handle_Success_ActivatesUserAndReturnsSuccess()
        {
            var user = new Common.Data.Entities.ApplicationUser { Id = "user-id", UserName = "testuser", IsActive = false };
            ...
            _userManagerMock
                .Setup(m => m.UpdateAsync(It.IsAny<Common.Data.Entities.ApplicationUser>()))
                .ReturnsAsync(IdentityResult.Success);
