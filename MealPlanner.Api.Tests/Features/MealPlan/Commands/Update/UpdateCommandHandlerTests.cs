...
namespace MealPlanner.Api.Tests.Features.MealPlan.Commands.Update
{
    ...
    public class UpdateCommandHandlerTests
    {
        ...
        public async Task Handle_EntityNotFound_ReturnsFailedResponse()
        {
            ...
            _mapperMock.Verify(m => m.Map(It.IsAny<MealPlanEditModel>(), It.IsAny<Data.Entities.MealPlan>()), Times.Never);
            _repoMock.Verify(r => r.UpdateAsync(It.IsAny<Data.Entities.MealPlan>(), It.IsAny<CancellationToken>()), Times.Never);
        }
        ...
        public async Task Handle_SuccessfulUpdate_ReturnsSuccess()
        {
            ...
            var existing = new Data.Entities.MealPlan { Id = id, Name = "OldPlan" };
        ...
        public async Task Handle_ExceptionDuringUpdate_LogsError_AndReturnsFailedResponse()
        {
            ...
            var existing = new Data.Entities.MealPlan { Id = id, Name = "OldX" };
