...
namespace MealPlanner.Api.Tests.Features.ShoppingList.Commands.Delete
{
    ...
    public class DeleteCommandHandlerTests
    {
        ...
        public async Task Handle_ItemNotFound_ReturnsFailedResponse()
        {
            ...
            _repoMock.Verify(r => r.DeleteAsync(It.IsAny<Common.Data.Entities.ShoppingList>(), It.IsAny<CancellationToken>()), Times.Never);
        }
        ...
        public async Task Handle_ItemFound_DeletesAndReturnsSuccess()
        {
            ...
            var entity = new Common.Data.Entities.ShoppingList { Id = id, Name = "Weekly" };
        ...
        public async Task Handle_ExceptionDuringDelete_LogsError_AndReturnsFailedResponse()
        {
            ...
            var entity = new Common.Data.Entities.ShoppingList { Id = id, Name = "ToDelete" };
            ...
            Assert.That(result, Is.Not.Null);
            Assert.That(result!.Succeeded, Is.False);
            Assert.That(result.Message, Is.EqualTo("An error occurred when deleting the shopping list."));
