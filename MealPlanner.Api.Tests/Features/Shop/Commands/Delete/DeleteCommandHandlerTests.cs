...
namespace MealPlanner.Api.Tests.Features.Shop.Commands.Delete
{
    ...
    public class DeleteCommandHandlerTests
    {
        ...
        public async Task Handle_ItemNotFound_ReturnsFailedResponse()
        {
            ...
            _repoMock.Verify(r => r.DeleteAsync(It.IsAny<Data.Entities.Shop>(), It.IsAny<CancellationToken>()), Times.Never);
        }
        ...
        public async Task Handle_ItemFound_DeletesAndReturnsSuccess()
        {
            ...
            var entity = new Data.Entities.Shop { Id = id, Name = "Shop1" };
        ...
        public async Task Handle_ExceptionDuringDelete_LogsError_AndReturnsFailedResponse()
        {
            ...
            var entity = new Data.Entities.Shop { Id = id, Name = "ShopX" };
            ...
            Assert.That(result, Is.Not.Null);
            Assert.That(result!.Succeeded, Is.False);
            Assert.That(result.Message, Is.EqualTo("An error occurred when deleting the shop."));
