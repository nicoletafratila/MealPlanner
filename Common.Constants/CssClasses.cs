namespace Common.Constants
{
    public class CssClasses
    {
        ...
        public const string GridTemplateClass = "table";
        public const string GridTemplateNoRowsClass = "table table-grid";

        public const string TableTemplateEmptyClass = "table table-sm caption-top";
        public const string TableTemplateWithItemsClass = "table table-sm table-striped table-hover caption-top";
    }
}
