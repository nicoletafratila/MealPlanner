...
namespace RecipeBook.Services.Tests
{
    [TestFixture]
    public class UnitServiceTests
    {
        ...
        private static RecipeBookApiConfig CreateConfig()
        {
            ...
            var cfg = new RecipeBookApiConfig(configuration)
            {
                ...
                {
                    [RecipeBookControllers.Unit] = UnitPath
                }
            };
            ...
            IMemoryCache? cache = null)
        {
            ...
            return new UnitService(httpClient, tokenProvider, config, cache ?? new MemoryCache(new MemoryCacheOptions()), logger);
        }
