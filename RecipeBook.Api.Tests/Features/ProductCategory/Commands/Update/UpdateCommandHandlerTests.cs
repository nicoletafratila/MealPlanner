...
namespace RecipeBook.Api.Tests.Features.ProductCategory.Commands.Update
{
    ...
    public class UpdateCommandHandlerTests
    {
        ...
        public async Task Handle_EntityNotFound_ReturnsFailedResponse()
        {
            ...
            _mapperMock.Verify(m => m.Map(It.IsAny<ProductCategoryEditModel>(), It.IsAny<Data.Entities.ProductCategory>()), Times.Never);
            _repoMock.Verify(r => r.UpdateAsync(It.IsAny<Data.Entities.ProductCategory>(), CancellationToken.None), Times.Never);
        }
        ...
        public async Task Handle_SuccessfulUpdate_ReturnsSuccess()
        {
            ...
            var existing = new Data.Entities.ProductCategory
            {
                Id = id,
                Name = "OldCat"
            };
