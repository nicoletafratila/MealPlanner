...
namespace RecipeBook.Api.Tests.Features.Recipe.Queries.GetEdit
{
    [TestFixture]
    public class GetEditQueryHandlerTests
    {
        ...
        public async Task Handle_EntityFound_ReturnsMappedModel()
        {
            ...
            var mapped = new RecipeEditModel
            {
                Id = id,
                Name = "My Recipe"
            };
            ...
            _mapperMock
                .Setup(m => m.Map<RecipeEditModel>(entity))
                .Returns(mapped);
            ...
            _repoMock.Verify(
                ...
                Times.Once);
            _mapperMock.Verify(m => m.Map<RecipeEditModel>(entity), Times.Once);
        }
        ...
        public async Task Handle_EntityNotFound_ReturnsEmptyModelWithId()
        {
            ...
            _repoMock.Verify(
                r => r.GetByIdIncludeIngredientsAsync(id, It.IsAny<CancellationToken>()),
                Times.Once);
            _mapperMock.Verify(m => m.Map<RecipeEditModel>(It.IsAny<RecipeBook.Data.Entities.Recipe>()), Times.Never);
        }
