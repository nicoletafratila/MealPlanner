    ...
    public partial class ProductCategoriesViewModel(ProductCategoryService categoryService) : BaseViewModel
    {
        ...
        private async Task LoadAsync()
        {
            ...
            try
            {
                ...
                var result = await categoryService.SearchAsync(new QueryParameters<ProductCategoryModel> { PageNumber = CurrentPage, PageSize = PageSize, Filters = filters, Sorting = DefaultSorting });
