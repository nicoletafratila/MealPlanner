...
namespace MealPlanner.UI.Mobile.ViewModels.RecipeBook
{
    ...
    public partial class RecipeCategoryEditViewModel(RecipeCategoryService categoryService) : BaseViewModel
    {
        ...
        [ObservableProperty]
        private RecipeCategoryEditModel _model = new();
        ...
        private async Task DeleteAsync()
        {
            ...
            var confirm = await Shell.Current.DisplayAlertAsync(
                Pages.RecipeBook.Resources.RecipeCategoryEditPage.DeleteConfirmTitle,
                Pages.RecipeBook.Resources.RecipeCategoryEditPage.DeleteConfirmMessage,
                Pages.RecipeBook.Resources.RecipeCategoryEditPage.DeleteButton,
                Pages.RecipeBook.Resources.RecipeCategoryEditPage.CancelButton);
            if (!confirm) return;
        ...
        private async Task SaveAsync()
        {
            ...
            {
                SetError(RecipeBookSharedMessages.RecipeCategoryNameRequired);
                return;
            }

            if (Model.DisplaySequence < 0)
            {
                SetError(RecipeBookSharedMessages.CategoryDisplaySequenceRequired);
                return;
            }
