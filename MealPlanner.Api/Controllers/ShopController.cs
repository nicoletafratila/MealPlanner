...
namespace MealPlanner.Api.Controllers
{
    ...
    public class ShopController(ISender mediator) : ControllerBase
    {
        ...
        [HttpGet("edit")]
        public async Task<ActionResult<ShopEditModel>> GetEditAsync([FromQuery] int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<CommandResponse?>> PostAsync([FromBody] ShopEditModel model)
        {
        ...
        [HttpPut]
        public async Task<ActionResult<CommandResponse?>> PutAsync([FromBody] ShopEditModel model)
        {
