...
{
    public class SearchQueryHandler(IShopRepository repository, IMapper mapper, ICurrentUserService currentUserService) : IRequestHandler<SearchQuery, PagedList<ShopModel>>
    {
        ...
        public async Task<PagedList<ShopModel>> Handle(SearchQuery request, CancellationToken cancellationToken)
        {
            ...
            return new PagedList<ShopModel>(models, metadata);
        }
    }
}
