...
{
    /// <summary>
    /// Handles deletion of a shop.
    /// </summary>
    public class DeleteCommandHandler(IShopRepository repository, ILogger<DeleteCommandHandler> logger) : IRequestHandler<DeleteCommand, CommandResponse?>
    {
