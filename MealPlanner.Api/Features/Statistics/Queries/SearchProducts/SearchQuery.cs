...
{
    /// <summary>
    /// Query to retrieve favorite product statistics, optionally filtered by product category IDs.
    /// </summary>
    public class SearchQuery : IRequest<IList<StatisticModel>>
    {
        /// <summary>
        /// Comma-separated list of product category IDs to filter by (e.g. "1,2,3").
