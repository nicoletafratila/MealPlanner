...
{
    public static async Task SeedProductCategoriesAsync(MealPlannerDbContext context)
    {
    ...
    public static async Task SeedRecipeCategoriesAsync(MealPlannerDbContext context)
    {
