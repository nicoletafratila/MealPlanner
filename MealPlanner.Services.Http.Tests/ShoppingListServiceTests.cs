...
namespace MealPlanner.Services.Http.Tests
{
    ...
    public class ShoppingListServiceTests
    {
        ...
        {
            var userAResult = new PagedList<ShoppingListModel>([new ShoppingListModel()], new Metadata { PageNumber = 1, PageSize = 10, TotalCount = 1 });
            var userBResult = new PagedList<ShoppingListModel>([new ShoppingListModel(), new ShoppingListModel()], new Metadata { PageNumber = 1, PageSize = 10, TotalCount = 2 });
        ...
        public async Task MakeShoppingListAsync_PostsCreateModel_AndReturnsEditModel()
        {
            ...
            var expectedEdit = new ShoppingListEditModel { Id = Guid.NewGuid() };
        ...
        {
            // Arrange
            var model = new ShoppingListEditModel { Id = Guid.NewGuid() };
