using System.Net.Http.Json;using Common.Constants; using Common.Core; using Common.Http; using Common.Models; using Common.Pagination; using Common.Services; using Microsoft.Extensions.Caching.Memory; using Microsoft.Extensions.Logging; using Microsoft.Extensions.Primitives; using RecipeBook.Shared.Constants; using RecipeBook.Shared.Models;

namespace RecipeBook.Services.Core
{
    public class UnitService(HttpClient httpClient, Common.Http.ITokenProvider tokenProvider, IMemoryCache cache, ILogger<UnitService> logger)
