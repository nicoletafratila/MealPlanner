...
namespace RecipeBook.Services.Core.Converters
{
    public static class UnitConverter
    {
        private static Func<IMapper> _mapperFactory = () => ServiceLocator.GetInstance<IMapper>();
        private static Func<decimal, Unit, Unit, decimal> _convertCore = (value, from, to) => Common.Services.Converters.UnitConverter.Convert(value, from, to);
