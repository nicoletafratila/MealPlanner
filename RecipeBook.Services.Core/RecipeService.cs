using System.Net.Http.Json;using Common.Constants; using Common.Core; using Common.Http; using Common.Models; using Common.Pagination; using Common.Services; using MealPlanner.Shared.Models; using Microsoft.Extensions.Logging; using RecipeBook.Shared.Constants; using RecipeBook.Shared.Models;

namespace RecipeBook.Services.Core
{
    public class RecipeService(HttpClient httpClient, Common.Http.ITokenProvider tokenProvider, ILogger<RecipeService> logger)
