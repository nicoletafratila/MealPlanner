...
namespace RecipeBook.Api.Controllers
{
    ...
    public class ProductController(ISender mediator) : ControllerBase
    {
        ...
        [HttpGet("edit")]
        public async Task<ActionResult<ProductEditModel>> GetEditAsync([FromQuery] int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<CommandResponse?>> PostAsync([FromBody] ProductEditModel model)
        {
        ...
        [HttpPut]
        public async Task<ActionResult<CommandResponse?>> PutAsync([FromBody] ProductEditModel model)
        {
